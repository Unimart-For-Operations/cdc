...
All remaining modules (core-utils, containerization, go, ssh, python, terraform, aws, azure, direnv, zoxide, zsh, sesh, dms, hyprland, wezterm, work/*) either have no visual configuration or are governed by external systems (DMS).
